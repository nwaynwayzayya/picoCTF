...
# Step 2: Inspect the page using developer tools. Go to the "Sources" tab. There, we can see a suspicious file named "G82XCw5CX3.js" where our flag or a clue for the flag might be.

# Step 3: Read the 'G82XCw5CX3.js' file. We can notice that some words like variables are unreadable. (eg - _0x553839). The full source code below the notes section. 
```
